...
const MERMAID_PALETTES: Record<Theme, { fontFamily: string; vars: MermaidVars }> = {
  ...
  ascii: {
    ...
    vars: {
      ...
      primaryBorderColor: '#0e0e0e',
      secondaryColor: '#ecece6',
      secondaryTextColor: '#0e0e0e',
      secondaryBorderColor: '#0e0e0e',
      tertiaryColor: '#fdfdf9',
      tertiaryTextColor: '#0e0e0e',
      tertiaryBorderColor: '#0e0e0e',
      lineColor: '#0e0e0e',
      textColor: '#0e0e0e',
      mainBkg: '#f5f5f0',
      nodeBorder: '#0e0e0e',
      ...
      titleColor: '#0e0e0e',
      edgeLabelBackground: '#fdfdf9',
      nodeTextColor: '#0e0e0e',
      actorBkg: '#f5f5f0',
      actorBorder: '#0e0e0e',
      actorTextColor: '#0e0e0e',
      actorLineColor: '#0e0e0e',
      signalColor: '#0e0e0e',
      signalTextColor: '#0e0e0e',
      labelBoxBkgColor: '#ecece6',
      labelBoxBorderColor: '#0e0e0e',
      labelTextColor: '#0e0e0e',
      loopTextColor: '#0e0e0e',
      noteBkgColor: '#fdfdf9',
      noteTextColor: '#0e0e0e',
      noteBorderColor: '#0e0e0e',
      activationBkgColor: '#ecece6',
      activationBorderColor: '#0e0e0e',
      sequenceNumberColor: '#fdfdf9',
      attributeBackgroundColorOdd: '#fdfdf9',
      attributeBackgroundColorEven: '#f5f5f0',
      pie1: '#0e0e0e', pie2: '#3a3a3a', pie3: '#5a5a5a', pie4: '#757575',
      pie5: '#909090', pie6: '#a8a8a8', pie7: '#c0c0c0', pie8: '#d8d8d0',
    },
  },
};
