...
const MERMAID_PALETTES: Record<Theme, { fontFamily: string; vars: MermaidVars }> = {
  ...
  brutalist: {
    ...
    vars: {
      ...
      noteTextColor: '#000000',
      noteBorderColor: '#000000',
      activationBkgColor: '#fff200',
      activationBorderColor: '#000000',
      sequenceNumberColor: '#ffffff',
      attributeBackgroundColorOdd: '#ffffff',
      attributeBackgroundColorEven: '#f0f0f0',
      pie1: '#000000', pie2: '#fff200', pie3: '#c00000', pie4: '#0000ee',
      pie5: '#006400', pie6: '#595959', pie7: '#b0b0b0', pie8: '#e0e0e0',
    },
  },
  newspaper: {
    fontFamily: '"Lora", "Georgia", "Noto Serif JP", serif',
  ...
  sumi: {
    fontFamily: '"Klee One", "Noto Serif JP", "Hiragino Mincho ProN", serif',
    vars: {
      primaryColor: '#f3f0e7',
      primaryTextColor: '#2b2723',
      primaryBorderColor: '#2b2723',
      secondaryColor: '#e7e2d4',
      secondaryTextColor: '#4a453e',
      secondaryBorderColor: '#888279',
      tertiaryColor: '#fbfaf6',
      tertiaryTextColor: '#4a453e',
      tertiaryBorderColor: '#c8c2b3',
      lineColor: '#2b2723',
      textColor: '#2b2723',
      mainBkg: '#f3f0e7',
      nodeBorder: '#2b2723',
      clusterBkg: '#fbfaf6',
      clusterBorder: '#888279',
      titleColor: '#a8332b',
      edgeLabelBackground: '#fbfaf6',
      nodeTextColor: '#2b2723',
      actorBkg: '#f3f0e7',
      actorBorder: '#2b2723',
      actorTextColor: '#2b2723',
      actorLineColor: '#888279',
      signalColor: '#2b2723',
      signalTextColor: '#2b2723',
      labelBoxBkgColor: '#e7e2d4',
      labelBoxBorderColor: '#888279',
      labelTextColor: '#4a453e',
      loopTextColor: '#a8332b',
      noteBkgColor: '#e8d873',
      noteTextColor: '#2b2723',
      noteBorderColor: '#888279',
      activationBkgColor: '#e7e2d4',
      activationBorderColor: '#2b2723',
      sequenceNumberColor: '#fbfaf6',
      attributeBackgroundColorOdd: '#fbfaf6',
      attributeBackgroundColorEven: '#f3f0e7',
      pie1: '#2b2723', pie2: '#4a453e', pie3: '#888279', pie4: '#a8332b',
      pie5: '#2b4a8a', pie6: '#2f6131', pie7: '#8a5a14', pie8: '#5e2787',
    },
  },
  galaxy: {
    fontFamily: '"Inter", "Noto Sans JP", sans-serif',
  ...
  codex: {
    fontFamily: '"Lora", "EB Garamond", "Noto Serif JP", serif',
    vars: {
      primaryColor: '#ddcca4',
      primaryTextColor: '#2b1a08',
      primaryBorderColor: '#6e5a35',
      secondaryColor: '#d0bd8e',
      secondaryTextColor: '#3f2912',
      secondaryBorderColor: '#b89a5c',
      tertiaryColor: '#e8dab8',
      tertiaryTextColor: '#9b1c1c',
      tertiaryBorderColor: '#c8af72',
      lineColor: '#6e5a35',
      textColor: '#2b1a08',
      mainBkg: '#ddcca4',
      nodeBorder: '#6e5a35',
      clusterBkg: '#e8dab8',
      clusterBorder: '#b89a5c',
      titleColor: '#9b1c1c',
      edgeLabelBackground: '#e8dab8',
      nodeTextColor: '#2b1a08',
      actorBkg: '#ddcca4',
      actorBorder: '#6e5a35',
      actorTextColor: '#2b1a08',
      actorLineColor: '#b89a5c',
      signalColor: '#9b1c1c',
      signalTextColor: '#2b1a08',
      labelBoxBkgColor: '#d0bd8e',
      labelBoxBorderColor: '#b89a5c',
      labelTextColor: '#3f2912',
      loopTextColor: '#9b1c1c',
      noteBkgColor: '#c19a35',
      noteTextColor: '#2b1a08',
      noteBorderColor: '#6e5a35',
      activationBkgColor: '#d0bd8e',
      activationBorderColor: '#6e5a35',
      sequenceNumberColor: '#e8dab8',
      attributeBackgroundColorOdd: '#e8dab8',
      attributeBackgroundColorEven: '#ddcca4',
      pie1: '#9b1c1c', pie2: '#c19a35', pie3: '#1c3a8a', pie4: '#1c5c2c',
      pie5: '#6a2a8a', pie6: '#8a5a14', pie7: '#5a3e1a', pie8: '#7a6a40',
    },
  },
  spotlight: {
    fontFamily: '"Inter", "Lora", "Noto Serif JP", serif',
    vars: {
      primaryColor: '#161520',
      primaryTextColor: '#fef6e0',
      primaryBorderColor: '#ffb24d',
      secondaryColor: '#1e1d2e',
      secondaryTextColor: '#d4cfb8',
      secondaryBorderColor: '#2a2840',
      tertiaryColor: '#0e0d12',
      tertiaryTextColor: '#ffc471',
      tertiaryBorderColor: '#1a1928',
      lineColor: '#ffb24d',
      textColor: '#fef6e0',
      mainBkg: '#161520',
      nodeBorder: '#ffb24d',
      clusterBkg: '#0e0d12',
      clusterBorder: '#2a2840',
      titleColor: '#ffc471',
      edgeLabelBackground: '#0e0d12',
      nodeTextColor: '#fef6e0',
      actorBkg: '#161520',
      actorBorder: '#ffb24d',
      actorTextColor: '#fef6e0',
      actorLineColor: '#2a2840',
      signalColor: '#ffb24d',
      signalTextColor: '#fef6e0',
      labelBoxBkgColor: '#1e1d2e',
      labelBoxBorderColor: '#2a2840',
      labelTextColor: '#d4cfb8',
      loopTextColor: '#ffc471',
      noteBkgColor: '#2a2840',
      noteTextColor: '#fef6e0',
      noteBorderColor: '#ffb24d',
      activationBkgColor: '#1e1d2e',
      activationBorderColor: '#ffb24d',
      sequenceNumberColor: '#0e0d12',
      attributeBackgroundColorOdd: '#0e0d12',
      attributeBackgroundColorEven: '#161520',
      pie1: '#ffb24d', pie2: '#74c0ff', pie3: '#74e0a0', pie4: '#ff7474',
      pie5: '#c084ff', pie6: '#ffc471', pie7: '#d4cfb8', pie8: '#6a6580',
    },
  },
  blueprint: {
  ...
  forest: {
    ...
    vars: {
      primaryColor: '#232820',
      primaryTextColor: '#e4e0d2',
      primaryBorderColor: '#5c6b50',
      secondaryColor: '#1b1f1c',
      secondaryTextColor: '#a9a594',
      secondaryBorderColor: '#2c322a',
      tertiaryColor: '#16191a',
      tertiaryTextColor: '#a3c98f',
      tertiaryBorderColor: '#232820',
      lineColor: '#8fb574',
      textColor: '#e4e0d2',
      mainBkg: '#232820',
      nodeBorder: '#8fb574',
      clusterBkg: '#16191a',
      clusterBorder: '#2c322a',
      titleColor: '#a3c98f',
      edgeLabelBackground: '#16191a',
      nodeTextColor: '#e4e0d2',
      actorBkg: '#232820',
      actorBorder: '#8fb574',
      actorTextColor: '#e4e0d2',
      actorLineColor: '#5c6b50',
      signalColor: '#cba24f',
      signalTextColor: '#e4e0d2',
      labelBoxBkgColor: '#1b1f1c',
      labelBoxBorderColor: '#2c322a',
      labelTextColor: '#a9a594',
      loopTextColor: '#cba24f',
      noteBkgColor: '#2c322a',
      noteTextColor: '#e4e0d2',
      noteBorderColor: '#8fb574',
      activationBkgColor: '#232820',
      activationBorderColor: '#8fb574',
      sequenceNumberColor: '#16191a',
      attributeBackgroundColorOdd: '#16191a',
      attributeBackgroundColorEven: '#1b1f1c',
      pie1: '#8fb574', pie2: '#cba24f', pie3: '#a3c98f', pie4: '#dab15a',
      pie5: '#6f8a55', pie6: '#b3a45f', pie7: '#c0d8ac', pie8: '#7fb0d6',
    },
  },
  highcontrast: {
    fontFamily: '"Inter", "Noto Sans JP", sans-serif',
